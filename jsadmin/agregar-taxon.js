...
function insertar_taxon(){
  if(espaciosinifin($("#name").val())!= ""){
    ...
    var data = {tipo: 'agregartaxon', tipotaxon: tipotaxon, name: name, autor: autor, description: description, fatherclassbox: fatherclassbox, synonyms:synonyms, biology:biology}
