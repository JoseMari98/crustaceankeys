...
<head>
	...
	<script src="../jsadmin/editar-asociar-caracteristica.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar asociar caract. matricial a taxón</h2></div>
		  		<form enctype="multipart/form-data" id="asociarcaracteristicaform" class="a-tabla-animal" method="post" >
                    ...
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona la característica que desea editar</h4></div>
      				<select class="form-control" id="caracteristicascreadas" onchange="rellenar_taxones()">
      					<!-- Rellenado con ajax -->
                    </select>
                    <br>
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el taxón</h4></div>
      				<select class="form-control" id="taxonesbox" onchange="rellenar_valores()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
