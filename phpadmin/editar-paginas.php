...
<head>
	...
	<script src="../jsadmin/editar-paginas.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar página</h2></div>
		  		<form enctype="multipart/form-data" id="agregarterminoform" class="a-tabla-animal" method="post" >

					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione la página que desea modificar</h4></div>
      				<select class="form-control" id="paginascreadas" onchange="rellenar_informacion_pagina()">
      					<!-- Rellenado con ajax -->
      				</select>

					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Contenido</h4></div>

					<div id="contenido"></div>
					<br>

					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="editarcontenido();" role="button">Guardar cambios</a>
