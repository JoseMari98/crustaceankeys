...
<head>
	...
	<script src="../jsadmin/editar-asociar-caracteristica-grupo.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar asociar caract. matricial a subgrupo</h2></div>
		  		<form enctype="multipart/form-data" id="asociarcaracteristicaform" class="a-tabla-animal" method="post" >
                    ...
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona la característica que desea editar</h4></div>
      				<select class="form-control" id="caracteristicascreadas" onchange="rellenar_grupos()">
      					<!-- Rellenado con ajax -->
                    </select>
                    <br>
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el subgrupo</h4></div>
      				<select class="form-control" id="gruposcreados" onchange="rellenar_valores()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Valores de la característica a seleccionar</h4></div>
					<select class="form-control" id="newvalue">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>Recuerda volver a poner nuevos valores al cambiar el grupo asociado.</p><!-- puede cambiar-->
	      </div>
