...
<head>
	...
	<script src="../jsadmin/editar-asociar-grupo-taxon.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar asociar taxón a grupo</h2></div>
				  <br>

		  		<form enctype="multipart/form-data" id="asociartaxonform" class="a-tabla-animal" method="post" >
				  <div style="display: flex; justify-content: center;">
					...
					<a class='btn btn-primary btn-sm' href='javascript:;' data-toggle='modal' data-target='#eliminarasociacionModal' role='button'>Eliminar asociación</a>					
                    <br>
					<br>
					<br>
				</form>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <p>¿Estas seguro que desea eliminar esta asociación?</p>
	      </div>
