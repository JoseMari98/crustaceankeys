...
<head>
	...
	<script src="../jsadmin/editar-imagenes-taxon.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar imagen del taxón</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">

					<div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el taxón en el que desea editar las imágenes</h4></div>
					<select class="form-control" id="taxonescreados" onchange="mostrarimagenes()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona la imagen que desea editar</h4></div>
