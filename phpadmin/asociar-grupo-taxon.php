...
<head>
	...
	<script src="../jsadmin/asociar-grupo-taxon.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Asociar taxón a grupo</h2></div>
				  <br>
		  		<form enctype="multipart/form-data" id="asociartaxonform" class="a-tabla-animal" method="post" >
                    ...
                    <select class="form-control" id="grupobox">
					</select>
					<br>
					...
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="asociar_taxon();" role="button">Asociar taxón</a>
					<br>
					<br>
				</form>
		  	</div>
