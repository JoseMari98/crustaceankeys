...
<head>
	...
	<script src="../jsadmin/agregar-dicotomica.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Crear característica dicotómica</h2></div>
		  		<form enctype="multipart/form-data" id="agregarcaracteristicaform" class="a-tabla-animal" method="post" >
                    
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Clave de identificación</h4></div>
                    <select class="form-control" id="gruposcreados" onchange="rellenar_taxon()"></select>
					<br>
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Característica padre</h4></div>
					<select class="form-control" id="fatherbox">
						<!-- Rellenado con ajax -->
					</select>				
                    <br>
					...
					<div style="display: flex; justify-content: center;">
					  	<div style="display: flex; flex-direction: column;">
							<label>
							<input class="form-control" type="radio" name="tipo" value="taxon" onchange="rellenar_taxon()" checked>Taxón
							</label>
						</div>
						<br>
						<div style="display: flex; flex-direction: column; margin-left: 20%;">
							<label>
							<input class="form-control" type="radio" name="tipo" value="subgrupo" onchange="rellenar_taxon()">Subgrupo
							</label>
						</div>
					</div>

					<div id="tituloCambiante" class="titulo-panel-control" style="text-align: center;"><h4>Taxón hijo</h4></div>
