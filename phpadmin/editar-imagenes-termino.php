...
<head>
	...
	<script src="../jsadmin/editar-imagenes-termino.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar imagen del término</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">

				<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione el término del que desea editar las imágenes</h4></div>
					<select class="form-control" id="terminoscreados" onchange="mostrarimagenes()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione la imagen que desea editar</h4></div>
					...
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="editarimagen();" role="button">Guardar imagen</a>
