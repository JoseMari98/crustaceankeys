...
<head>
	...
	<script src="../jsadmin/agregar-distribucion-taxon.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
			<br>
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Agregar Distribución Geográfica del taxón</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">
				<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione el taxón en el que desea insertar la Distribución Geográfica</h4></div>
					<select class="form-control" id="taxonescreados">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione archivo que desea insertar</h4></div>
					<div id="vista-previa"></div>
					<div id="divimagen">
					<input type="file" name="file[]" id="file">
					</div>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertardistribucion();" role="button">Guardar Distribución Geográfica</a><br>
