...
<head>
	...
	<script src="../jsadmin/editar-grupo.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar grupo</h2></div>
				  <br>

		  		<form enctype="multipart/form-data" id="editargrupoform" class="a-tabla-animal" method="post" >
				  <div style="display: flex; justify-content: center;">
					...
					<br>
                  <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el grupo que desea modificar</h4></div>
      				<select class="form-control" id="gruposcreados" onchange="rellenar_grupo()">
      					<!-- Rellenado con ajax -->
      				</select>
                      <br>
					...
					<select class="form-control" id="grupospadres">
                      ...
                      <br>
                    <a class="btn btn-primary btn-sm" href='javascript:;' onclick="editar_grupo();" role="button">Guardar grupo</a>
					<a class='btn btn-primary btn-sm' href='javascript:;' data-toggle='modal' data-target='#eliminargrupoModal' role='button'>Eliminar grupo</a>
				</form>
		  	</div>
		</div>
	</div>
    ...
    <!-- Modal eliminar-->
	<div id="eliminargrupoModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<p>Estás apunto de eliminar un grupo.</p>
	        <p>Al eliminarla se borrará todo en cascada.</p>
	        <p>¿Estas seguro que desea eliminar este grupo?</p>
	      </div>
	      <div class="modal-footer">
	      	<a class="btn btn-primary" href='javascript:;' onclick="eliminar_grupo();" role="button" data-dismiss="modal">Si</a>
