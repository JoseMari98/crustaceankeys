...
<head>
	...
	<script src="../jsadmin/editar-claves.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar clave</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">

				  	<div style="display: flex; justify-content: center;">
						<div style="display: flex; flex-direction: column;">
							<label>
							<input class="form-control" type="radio" name="tipo" value="matricial" onchange="claves_creadas()" checked>Matricial
							</label>
						</div>
						<br>
						<div style="display: flex; flex-direction: column; margin-left: 20%;">
							<label>
							<input class="form-control" type="radio" name="tipo" value="dicotomica" onchange="claves_creadas()">Dicotómica
							</label>
						</div>
					</div>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione el grupo vinculado a la clave que desea editar</h4></div>
					<select class="form-control" id="clavescreadas" onchange="mostrarimagenes()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Descripción de la clave</h4></div>
					<input class="form-control" type="text" id="descripcion" required></input>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione la imagen de la clave que desea editar</h4></div>
					...
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="editarclave();" role="button">Guardar cambios</a>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="borrarclave();" role="button">Eliminar clave</a>
					<br>
