...
<head>
	...
	<script src="../jsadmin/editar-caracteristicas.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar característica matricial</h2></div>
		  		<form enctype="multipart/form-data" id="agregarcaracteristicaform" class="a-tabla-animal" method="post" >
                    ...
                    <select class="form-control" id="grupobox" onchange="rellenar_caracteristicas()">
					</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Categoría taxonómica</h4></div>
					<select class="form-control" id="categoriabox" onchange="rellenar_caracteristicas()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Nombre de la característica</h4></div>
                    <input class="form-control" type="text" id="name" required></input>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Tipo del valor de la característica</h4></div>
      				<select class="form-control" id="typesbox" onchange="vaciarvalor()">

      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Valor/es</h4><br><h5>Nota: Si introduce mas de un valor, sepárelo por ¨;¨ y un espacio</h5></div>
					<input class="form-control" type="text" id="value" required></input>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Grupo de la característica</h4></div>
                    <select class="form-control" id="gruposcreados">
					</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Categoría taxonómica</h4></div>
					<select class="form-control" id="categoriascreadas">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<br>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>Recuerda volver a poner nuevos valores al cambiar el tipo de valor de la característica.</p><!-- puede cambiar-->
			<p>Recuerda volver a cambiar los valores para las características asociadas.</p><!-- puede cambiar-->
	      </div>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <p>Al eliminarla los taxones que la tengan dejarán de tenerla.</p>
