...
<head>
	...
	<script src="../jsadmin/agregar-esquema.js"></script>
...
<body>
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Añadir Esquema General</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Breve descripción del Esquema</h4></div>
					<input class="form-control" type="text" id="descripcion" required></input>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertarimagen();" role="button">Guardar Esquema</a><br>
