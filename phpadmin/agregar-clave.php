...
<head>
	...
	<script src="../jsadmin/agregar-clave.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Agregar clave</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Listado de Grupos de identificación</h4></div>
					...
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertarclave();" role="button">Guardar clave</a><br>
