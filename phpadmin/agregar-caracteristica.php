...
<head>
	...
	<script src="../jsadmin/agregar-caracteristica.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Crear característica matricial</h2></div>
		  		<form enctype="multipart/form-data" id="agregarcaracteristicaform" class="a-tabla-animal" method="post" >
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Tipo de valor de la característica</h4></div>
					<select class="form-control" id="typesbox">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
                    ...
                    <select class="form-control" id="gruposcreados"></select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Categoría taxonómica</h4></div>
					<select class="form-control" id="categoriabox">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertar_caracteristica();" role="button">Guardar caracteristica</a>
					<br>
				</form>
		  	</div>
		</div>
