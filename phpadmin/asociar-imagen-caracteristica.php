...
<head>
	...
	<script src="../jsadmin/asociar-imagen-caracteristica.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
				  <div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Asociar imagen a característica</h2></div>
				  <br>
				  <form enctype="multipart/form-data" id="asociarimagenform" class="a-tabla-animal" method="post" >
				  <div style="display: flex; justify-content: center;">
					...
					<br>
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona la imagen que desea insertar</h4></div>
					...
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="asociar_imagen();" role="button">Asociar imagen</a>
				</form>
		  	</div>
		</div>
	</div>
