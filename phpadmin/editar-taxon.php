...
<head>
	...
	<script src="../jsadmin/editar-taxon.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar taxón</h2></div>
		  		<form enctype="multipart/form-data" id="agregartaxonform" class="a-tabla-animal" method="post" >

					<div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el taxón que desea modificar</h4></div>
      				<select class="form-control" id="taxonescreados" onchange="rellenar_datos_taxon()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Categoría taxonómica</h4></div>
      				<select class="form-control" id="taxonesbox" onchange="cambiarclass()">

      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Taxón padre</h4></div>
					<select class="form-control" id="fatherclassbox">

      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Nombre del taxón</h4></div>
					<input class="form-control" type="text" id="name" required></input>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Autor</h4></div>
					<input class="form-control" type="text" id="autor"></input>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Descripción</h4></div>

					<div id="description"></div>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Sinónimos</h4></div>

					<div id="synonyms"></div>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Biología</h4></div>

					<div id="biology"></div>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="editartaxon();" role="button">Guardar taxón</a>
					<a class='btn btn-primary btn-sm' href='javascript:;' data-toggle='modal' data-target='#eliminarclassModal' role='button'>Eliminar taxón</a>
					<br>
					<br>
					<br>
				</form>
	...
	<!-- Modal cambio-->
	<div id="cambiarclassModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>Recuerda volver a escoger al taxón padre al cambiar de categoría taxonómica</p>
	      </div>
	...
	<!-- Modal eliminar-->
	<div id="eliminarclassModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<p>Estas apunto de eliminar un taxón.</p>
	        <p>Es posible que al eliminar este taxon algunos taxones hijos queden huerfanos.</p>
	        <p>¿Estas seguro que desea eliminar este taxón?</p>
	      </div>
	      <div class="modal-footer">
	      	<a class="btn btn-primary" href='javascript:;' onclick="eliminartaxon();" role="button" data-dismiss="modal">Si</a>
