...
<head>
	...
	<script src="../jsadmin/imagenes-termino.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Insertar imagen del término</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione el término en el que desea insertar la imagen</h4></div>
					<select class="form-control" id="terminoscreados">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione la imagen que desea insertar</h4></div>
					<div id="vista-previa"></div>
					<div id="divimagen">
					<input type="file" name="file[]" id="file">
					</div>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Nombre de la imagen</h4></div>
					<input class="form-control" type="text" id="nombre" required></input>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertarimagen();" role="button">Guardar imagen</a><br>
