...
<head>
	...
	<script src="../jsadmin/editar-esquema.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar Esquema General</h2></div>
		  		<form action="" method="post" enctype="multipart/form-data" class="a-tabla-animal" id="imagenes">

				<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione el Esquema General que desea editar</h4></div>
					<select class="form-control" id="esquemascreados" onchange="mostrarimagenesquema()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Haga click sobre el Esquema</h4></div>
					...
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="editaresquema();" role="button">Guardar Esquema</a>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="borraresquema();" role="button">Eliminar Esquema</a>
					<br>
					<br>
					<br>
					<br>
