...
if ($_FILES["file"]["name"][0] != ""){
    ...
    for ($i=0; $i<count($file['name']); $i++){
        ...
        if ($tipo != "image/jpeg" && $tipo != "image/png" && $tipo != "image/jpg" && $tipo != "image/gif"){
            ...
            $sql="INSERT INTO `imageterminosphp` (anchura,altura,tipo,imagen,name_ref,nombre,minidescripcion) VALUES ($width,$heigth,'$tipo','$foto',$taxon,'$nombre','$minidescripcion')";
            // echo $sql;
            $conexion->query($sql);
