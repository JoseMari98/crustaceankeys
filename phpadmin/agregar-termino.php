...
<head>
	...
	<script src="../jsadmin/agregar-termino.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Añadir Término</h2></div>
		  		<form enctype="multipart/form-data" id="agregarterminoform" class="a-tabla-animal" method="post" >
					...
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertar_termino();" role="button">Guardar término</a><a class="btn btn-primary btn-sm" href='javascript:;' onclick="limpiarFormulario();" role="button">Limpiar Formulario</a>
					<br>
					<br>
				</form>
		  	</div>
