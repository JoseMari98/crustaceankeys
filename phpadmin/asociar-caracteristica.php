...
<head>
	...
	<script src="../jsadmin/asociar-caracteristica.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Asociar caract. matricial a taxón</h2></div>
		  		<form enctype="multipart/form-data" id="asociarcaracteristicaform" class="a-tabla-animal" method="post" >
					...
					<br>
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el taxón que desea asociar</h4></div>
      				<select class="form-control" id="taxonescreados">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
