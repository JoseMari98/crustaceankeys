...
<head>
	...
	<script src="../jsadmin/editar-termino.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar término</h2></div>
		  		<form enctype="multipart/form-data" id="agregarterminoform" class="a-tabla-animal" method="post" >

					<div class="titulo-panel-control" style="text-align: center;"><h4>Seleccione el término que desea modificar</h4></div>
      				<select class="form-control" id="terminoscreados" onchange="rellenar_datos_termino()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					
					<div class="titulo-panel-control" style="text-align: center;"><h4>Nombre del término</h4></div>
					<input class="form-control" type="text" id="name" required></input>
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Definición</h4></div>

					<div id="definicion"></div>
					<br>

					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="editartermino();" role="button">Guardar término</a>
					<a class='btn btn-primary btn-sm' href='javascript:;' data-toggle='modal' data-target='#eliminarclassModal' role='button'>Eliminar término</a>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>Recuerde volver a escoger al taxón padre al cambiar de categoría taxonómica</p>
	      </div>
	...
	<div id="eliminarclassModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<p>Se encuentra a punto de eliminar el término del Glosario.</p>
	        <p>¿Está seguro de que desea eliminarlo?</p>
	      </div>
	      <div class="modal-footer">
	      	<a class="btn btn-primary" href='javascript:;' onclick="eliminartermino();" role="button" data-dismiss="modal">Si</a>
