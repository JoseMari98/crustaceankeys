...
<head>
	...
	<script src="../jsadmin/asociar-caracteristica-grupo.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Asociar caract. matricial a subgrupo</h2></div>
		  		<form enctype="multipart/form-data" id="asociarcaracteristicaform" class="a-tabla-animal" method="post" >
					...
					<br>
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona la característica que desea asociar</h4></div>
					...
					<br>
					<div class="titulo-panel-control" style="text-align: center;"><h4>Vista previa de imagen</h4></div>
					<div id="vista-previa"></div>
					<div id="divimagen">
					</div>
					<br>
                    <div class="titulo-panel-control" style="text-align: center;"><h4>Selecciona el subgrupo que desea asociar</h4></div>
      				<select class="form-control" id="gruposcreados">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="asociar_caracteristica();" role="button">Asociar caracteristica</a>
					<br>
					<br>
				</form>
		  	</div>
