...
<head>
	...
	<script src="../jsadmin/agregar-taxon.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Añadir taxón</h2></div>
		  		<form enctype="multipart/form-data" id="agregartaxonform" class="a-tabla-animal" method="post" >

					<div class="titulo-panel-control" style="text-align: center;"><h4>Elige la categoría taxonómica</h4></div>
      				<select class="form-control" id="taxonesbox" onchange="rellenar_padres()">
      					<!-- Rellenado con ajax -->
      				</select>
					<br>
					...
					<div id="biology"></div>
					<br>
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="insertar_taxon();" role="button">Guardar taxon</a>
					<br>
				</form>
		  	</div>
		</div>
