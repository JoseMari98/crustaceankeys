...
<head>
	...
	<script src="../jsadmin/editar-asociar-imagen-caracteristica.js"></script>
...
<body onload="iniciar()">
	...
	<div class="container">
		<div class="row">
		  	<div class="col-sm-12">
		  		<div class="titulo-panel-control" style="text-align: center;"><h2 style="text-decoration: underline;">Editar asociar imagen a característica</h2></div>
				  <br>

		  		<form enctype="multipart/form-data" id="editarasociarimagenform" class="a-tabla-animal" method="post" >
				  <div style="display: flex; justify-content: center;">
                    ...
                    <br>
					<div id="divvalores" class="titulo-panel-control" style="text-align: center;">
                        <h4>Valores de la característica seleccionada</h4>
                        <br>
                        <p id="valores"></p>
                    </div>
					...
					<a class="btn btn-primary btn-sm" href='javascript:;' onclick="borrarimagen();" role="button">Eliminar imagen</a>
                    <br>
				</form>
		  	</div>
		</div>
