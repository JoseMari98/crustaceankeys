...
class __TwigTemplate_09f1cb6aa2d60c6b94a2fecf089aa227715c030b963dea39248a40d6423a7c7c extends Twig_Template
{
...
(isset($context["image"]) ? $context["image"] : null)), 1 => array(0 => "button clear", 1 => _gettext("Clear")), 2 => array(0 => "button history", 1 => _gettext("History")), 3 => array(0 => "button options", 1 => _gettext("Options")), 4 => ((        // line 11
array_key_exists("cfg_bookmark", $context)) ? (array(0 => "button bookmarks", 1 => _gettext("Bookmarks"))) : (null)), 5 => array(0 => "button debug hide", 1 => _gettext("Debug SQL")))));
        ...
        echo "                    </span>
                ...
                ";
        // line 26
        if ( !twig_test_empty((isset($context["sql_history"]) ? $context["sql_history"] : null))) {
            // line 27
            echo "                    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["sql_history"]) ? $context["sql_history"] : null)));
...
$context["record"], "timevalue", array(), "array")) : (_gettext("During current session")))))));
        ...
        ";
        // line 97
        if ((isset($context["cfg_bookmark"]) ? $context["cfg_bookmark"] : null)) {
            // line 98
            ...
            echo "                <div class=\"content bookmark\">
                    ";
            // line 108
            echo (isset($context["bookmark_content"]) ? $context["bookmark_content"] : null);
            echo "
                </div>
...
";
    ...
    {
        return new Twig_Source("", "console/display.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/console/display.twig");
    }
}
