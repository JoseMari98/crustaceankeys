...
class __TwigTemplate_825bafbc9e39359d7c71cb8d95dfc0384dc692a5069b388d0cf0705bd9e4da78 extends Twig_Template
{
    ...
    <fieldset id=\"index_edit_fields\">
        ...
        echo "
                ...
                <input type=\"text\"
                    ...
                    value=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getName", array(), "method"), "html", null, true);
        echo "\"
                    onfocus=\"this.select()\" />
            </div>
        ...
        echo "
                ...
                ";
        // line 39
        echo $this->getAttribute((isset($context["index"]) ? $context["index"] : null), "generateIndexChoiceSelector", array(0 => (isset($context["create_edit_table"]) ? $context["create_edit_table"] : null)), "method");
        echo "
            </div>
        ...
        echo "                        </label>
                ...
                <input type=\"text\"
                    ...
                    value=\"";
        // line 57
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getKeyBlockSize", array(), "method"), "html", null, true);
        echo "\" />
            </div>
        ...
        echo "
                ...
                ";
        // line 70
        echo $this->getAttribute((isset($context["index"]) ? $context["index"] : null), "generateIndexTypeSelector", array(), "method");
        echo "
            </div>
        ...
        echo "                        </label>
                ...
                <input type=\"text\"
                    ...
                    value=\"";
        // line 86
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getParser", array(), "method"), "html", null, true);
        echo "\" />
            </div>
        ...
        echo "                        </label>
                ...
                <input type=\"text\"
                    ...
                    value=\"";
        // line 103
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getComment", array(), "method"), "html", null, true);
        echo "\" />
            </div>
        </div>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getColumns", array(), "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
            ...
            foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                // line 144
                echo "                                    ";
                if (((($this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getChoice", array(), "method") != "FULLTEXT") || preg_match("/(char|text)/i",                 // line 145
$context["field_type"])) && (($this->getAttribute(                // line 146
(isset($context["index"]) ? $context["index"] : null), "getChoice", array(), "method") != "SPATIAL") || twig_in_filter(                // line 147
$context["field_type"], (isset($context["spatial_types"]) ? $context["spatial_types"] : null))))) {
                    // line 148
                    echo "
                                        <option value=\"";
                    // line 149
            ...
            echo "                            </select>
                        ...
                        <td>
                            <input type=\"text\"
                                ...
                                value=\"";
            // line 164
            echo twig_escape_filter($this->env, ((($this->getAttribute((isset($context["index"]) ? $context["index"] : null), "getChoice", array(), "method") != "SPATIAL")) ? ($this->getAttribute(            // line 165
$context["column"], "getSubPart", array(), "method")) : ("")), "html", null, true);
        ...
        // line 169
        echo "                ";
        if (((isset($context["add_fields"]) ? $context["add_fields"] : null) > 0)) {
            // line 170
            echo "                    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(range(1, (isset($context["add_fields"]) ? $context["add_fields"] : null)));
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                    // line 180
                    echo "                                        ";
                    if ((isset($context["create_edit_table"]) ? $context["create_edit_table"] : null)) {
                        // line 181
                        echo "                                            ";
...
(isset($context["col_index"]) ? $context["col_index"] : null)) : ($context["field_name"])), "html", null, true);
                    echo "\"";
                    // line 187
                    echo ((((isset($context["j"]) ? $context["j"] : null) == $context["i"])) ? (" selected=\"selected\"") : (""));
                    echo ">
                                            ";
                    // line 188
                    echo twig_escape_filter($this->env, $context["field_name"], "html", null, true);
...
";
    ...
    {
        return new Twig_Source("", "table/index_form.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/table/index_form.twig");
    }
}
