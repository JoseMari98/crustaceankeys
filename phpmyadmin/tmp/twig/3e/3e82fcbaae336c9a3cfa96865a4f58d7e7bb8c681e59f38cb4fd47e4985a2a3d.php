...
class __TwigTemplate_43adb8b2e44edd8fca9cbf3777b81d551b42e7c01172f431dcc3542a2551f4fe extends Twig_Template
{
...
(isset($context["upload_id"]) ? $context["upload_id"] : null), "handler" =>         // line 10
(isset($context["handler"]) ? $context["handler"] : null), "pma_theme_image" =>         // line 11
(isset($context["pma_theme_image"]) ? $context["pma_theme_image"] : null)));
        // line 13
        echo "        //]]>
    </script>
    ...
    <form id=\"import_file_form\"
        ...
        class=\"ajax\"";
        // line 22
        if (((isset($context["handler"]) ? $context["handler"] : null) != "PhpMyAdmin\\Plugins\\Import\\Upload\\UploadNoplugin")) {
            // line 23
        ...
        // line 26
        echo twig_escape_filter($this->env, (isset($context["id_key"]) ? $context["id_key"] : null), "html", null, true);
        echo "\" value=\"";
        echo twig_escape_filter($this->env, (isset($context["upload_id"]) ? $context["upload_id"] : null), "html", null, true);
        echo "\" />
        ";
        // line 27
        if (((isset($context["import_type"]) ? $context["import_type"] : null) == "server")) {
            // line 28
            echo "            ";
...
(isset($context["import_type"]) ? $context["import_type"] : null) == "database")) {
            // line 30
            echo "            ";
        ...
        echo twig_escape_filter($this->env, (isset($context["import_type"]) ? $context["import_type"] : null), "html", null, true);
        echo "\" />
        ...
        if (((isset($context["import_type"]) ? $context["import_type"] : null) == "server")) {
            ...
            // line 41
            echo "                ";
        } elseif (((isset($context["import_type"]) ? $context["import_type"] : null) == "database")) {
            // line 42
            echo "                    ";
            echo twig_escape_filter($this->env, sprintf(_gettext("Importing into the database \"%s\""), (isset($context["db"]) ? $context["db"] : null)), "html", null, true);
            echo "
                ";
        } else {
            // line 44
            echo "                    ";
            echo twig_escape_filter($this->env, sprintf(_gettext("Importing into the table \"%s\""), (isset($context["table"]) ? $context["table"] : null)), "html", null, true);
            echo "
                ";
        }
        // line 46
        ...
        // line 53
        echo "            ";
        if ( !twig_test_empty((isset($context["compressions"]) ? $context["compressions"] : null))) {
            // line 54
            echo "                <div class=\"formelementrow\" id=\"compression_info\">
                    <p>
                        ";
            // line 56
            echo twig_escape_filter($this->env, sprintf(_gettext("File may be compressed (%s) or uncompressed."), twig_join_filter((isset($context["compressions"]) ? $context["compressions"] : null), ", ")), "html", null, true);
            echo "
                        <br>
                        ";
            // line 58
        ...
        echo "
            <div class=\"formelementrow\" id=\"upload_form\">
                ";
        // line 64
        if (((isset($context["is_upload"]) ? $context["is_upload"] : null) &&  !twig_test_empty((isset($context["upload_dir"]) ? $context["upload_dir"] : null)))) {
            // line 65
            echo "                    <ul>
                        <li>
                            ...
                            ";
            // line 68
            echo PhpMyAdmin\Util::getBrowseUploadFileBlock((isset($context["max_upload_size"]) ? $context["max_upload_size"] : null));
            echo "
                            ";
            // line 69
            ...
            // line 73
            if (( !twig_test_empty((isset($context["timeout_passed_global"]) ? $context["timeout_passed_global"] : null)) &&  !twig_test_empty((isset($context["local_import_file"]) ? $context["local_import_file"] : null)))) {
                // line 74
...
(isset($context["import_list"]) ? $context["import_list"] : null),             // line 78
(isset($context["upload_dir"]) ? $context["upload_dir"] : null));
            // line 79
            echo "
                        </li>
                    </ul>
...
(isset($context["is_upload"]) ? $context["is_upload"] : null)) {
            // line 83
            echo "                    ";
            echo PhpMyAdmin\Util::getBrowseUploadFileBlock((isset($context["max_upload_size"]) ? $context["max_upload_size"] : null));
            echo "
...
(isset($context["import_list"]) ? $context["import_list"] : null),             // line 90
(isset($context["upload_dir"]) ? $context["upload_dir"] : null));
            // line 91
            echo "
                ";
        ...
        if ((isset($context["is_encoding_supported"]) ? $context["is_encoding_supported"] : null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                echo "\"
                                ";
                // line 102
                if (((twig_test_empty((isset($context["import_charset"]) ? $context["import_charset"] : null)) && ($context["charset"] == "utf-8")) || (                // line 103
$context["charset"] == (isset($context["import_charset"]) ? $context["import_charset"] : null)))) {
                    // line 104
...
(isset($context["dbi"]) ? $context["dbi"] : null),             // line 113
(isset($context["disable_is"]) ? $context["disable_is"] : null), "charset_of_file", "charset_of_file", "utf8", false);
            // line 118
            echo "
                ";
        }
        ...
        echo "</h3>
            ...
            ";
        // line 126
        if ((array_key_exists("timeout_passed", $context) && (isset($context["timeout_passed"]) ? $context["timeout_passed"] : null))) {
            // line 127
            ...
            echo "\" />
                    ";
            // line 129
            echo twig_escape_filter($this->env, sprintf(_gettext("Previous import timed out, after resubmitting will continue from position %d."), (isset($context["offset"]) ? $context["offset"] : null)), "html", null, true);
            echo "
                </div>
            ";
        }
        ...
        echo "</h3>
            ";
        // line 169
        echo PhpMyAdmin\Plugins::getChoice("Import", "format", (isset($context["import_list"]) ? $context["import_list"] : null));
        echo "
        ...
        echo "            </p>
            ";
        // line 178
        echo PhpMyAdmin\Plugins::getOptions("Import", (isset($context["import_list"]) ? $context["import_list"] : null));
        echo "
        </div>
...
";
    ...
    {
        return new Twig_Source("", "display/import/import.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/display/import/import.twig");
    }
}
