...
class __TwigTemplate_8dcdd54e14c7174c3f3d9fca3a0d8ac3428a8affb61113a2c2ca0fbe04757629 extends Twig_Template
{
    ...
    ";
        ...
        if (((isset($context["handler"]) ? $context["handler"] : null) != "PhpMyAdmin\\Plugins\\Import\\Upload\\UploadNoplugin")) {
            ...
            // line 9
            echo "            ";
            $context["ajax_url"] = ((("import_status.php?id=" . (isset($context["upload_id"]) ? $context["upload_id"] : null)) . "&") . PhpMyAdmin\Url::getCommonRaw(array("import_status" => 1)));
            // line 12
            echo "            ";
            ...
            echo twig_escape_filter($this->env, (isset($context["pma_theme_image"]) ? $context["pma_theme_image"] : null), "html", null, true);
            echo "ajax_clock_small.gif\" width=\"16\" height=\"16\" alt=\"ajax clock\" /> ";
            echo (isset($context["promot_str"]) ? $context["promot_str"] : null);
            echo "');
                        ...
                        var statustext = PMA_sprintf(
                            \"";
            // line 75
            echo (isset($context["statustext_str"]) ? $context["statustext_str"] : null);
            echo "\",
                            formatBytes(
            ...
            echo "                            \$(\"#importmain\").hide();
                            ...
                            .html('";
            // line 88
            echo (isset($context["upload_html"]) ? $context["upload_html"] : null);
            echo "')
                            .show();
                            import_start = now;
                        }
            ...
            echo "                            var used_time = now - import_start;
                            ...
                            var speed = PMA_sprintf(
                                \"";
            // line 97
            echo (isset($context["second_str"]) ? $context["second_str"] : null);
            echo "\",
                            ...
                            if (minutes > 0) {
                                estimated_time = \"";
            // line 105
            echo (isset($context["remaining_min"]) ? $context["remaining_min"] : null);
            echo "\"
                                    .replace(\"%MIN\", minutes)
                                    .replace(\"%SEC\", seconds);
                            }
                                ...
                                estimated_time = \"";
            // line 110
            echo (isset($context["remaining_second"]) ? $context["remaining_second"] : null);
            echo "\"
                                .replace(\"%SEC\", seconds);
                            }
            ...
            echo twig_escape_filter($this->env, (isset($context["pma_theme_image"]) ? $context["pma_theme_image"] : null), "html", null, true);
            echo "ajax_clock_small.gif\" width=\"16\" height=\"16\" alt=\"ajax clock\" /> ";
            echo (isset($context["processed_str"]) ? $context["processed_str"] : null);
            echo "')
                        .show();
                        \$(\"#import_form_status\").load(\"import_status.php?message=true&";
            // line 145
            echo (isset($context["import_url"]) ? $context["import_url"] : null);
            echo "\");
        ...
        ";
            ...
            echo (isset($context["image_tag"]) ? $context["image_tag"] : null);
            echo "');
            \$(\"#upload_form_status\").css(\"display\", \"none\");
        ";
        }
...
";
    ...
    {
        return new Twig_Source("", "display/import/javascript.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/display/import/javascript.twig");
    }
}
