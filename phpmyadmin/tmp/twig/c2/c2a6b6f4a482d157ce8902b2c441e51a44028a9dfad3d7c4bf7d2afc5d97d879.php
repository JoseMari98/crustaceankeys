...
class __TwigTemplate_7bb3956451af6ea5573a816e1c4661a5f49fc8dcda7b0e6359f12522a6985688 extends Twig_Template
{
...
<table id=\"partition_table\">
    <tr class=\"vmiddle\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["partition_options"]) ? $context["partition_options"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            echo "\"";
            // line 22
            if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_by", array(), "array") == $context["option"])) {
                // line 23
        ...
        echo "\"
                value=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_expr", array(), "array"), "html", null, true);
        echo "\" />)
        </td>
    </tr>
    <tr class=\"vmiddle\">
        ...
        <td colspan=\"2\">
            <input name=\"partition_count\" type=\"number\" min=\"2\"
                value=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_count", array(), "array"), "html", null, true);
        echo "\" />
        </td>
    </tr>
    ";
        // line 43
        if ($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "can_have_subpartitions", array(), "array")) {
            // line 44
            ...
            // line 48
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["sub_partition_options"]) ? $context["sub_partition_options"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 49
                echo "                    <option value=\"<?= \$option?>\"";
                // line 50
                if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_by", array(), "array") == $context["option"])) {
                    // line 51
                    echo "                            selected=\"selected\"";
                }
                // line 52
            ...
            echo "\"
                    value=\"";
            // line 61
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_expr", array(), "array"), "html", null, true);
            echo "\" />)
            </td>
        </tr>
        <tr class=\"vmiddle\">
            ...
            <td colspan=\"2\">
                <input name=\"subpartition_count\" type=\"number\" min=\"2\"
                       value=\"";
            // line 68
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_count", array(), "array"), "html", null, true);
            echo "\" />
            </td>
        </tr>
    ";
...
";
        // line 73
        if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_count", array(), "array") > 1)) {
            // line 74
        ...
        <thead><tr>
            ...
            ";
            // line 77
            if ($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "value_enabled", array(), "array")) {
                // line 78
                echo "                <th>";
            ...
            // line 80
            echo "            ";
            if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "can_have_subpartitions", array(), "array") && ($this->getAttribute(            // line 81
(isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_count", array(), "array") > 1))) {
                // line 82
                echo "                <th>";
        ...
        ";
            // line 93
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partitions", array(), "array"));
...
$context["partition"], "subpartition_count", array(), "array") + 1)) : (2));
                ...
                if ($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "value_enabled", array(), "array")) {
                    ...
                    // line 105
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable((isset($context["value_type_options"]) ? $context["value_type_options"] : null));
                    foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                        // line 106
                        echo "                                <option value=\"";
                        echo twig_escape_filter($this->env, $context["option"], "html", null, true);
            ...
            ";
                // line 127
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable((isset($context["subpartitions"]) ? $context["subpartitions"] : null));
                foreach ($context['_seq'] as $context["_key"] => $context["subpartition"]) {
                    // line 128
                    echo "                <tr>
                    ";
                    // line 129
                    if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "can_have_subpartitions", array(), "array") && ($this->getAttribute(                    // line 130
(isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_count", array(), "array") > 1))) {
                        // line 131
                        echo "                        <td>
                            <input type=\"text\" name=\"";
...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/partitions.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/columns_definitions/partitions.twig");
    }
}
