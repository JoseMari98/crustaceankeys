...
class __TwigTemplate_043ddf62ddc971882f8cda92e9a250504364869f59b7fa508a6472887755a88d extends Twig_Template
{
    ...
    <fieldset>
        ...
        ";
        // line 7
        if (twig_test_empty((isset($context["partitions"]) ? $context["partitions"] : null))) {
            // line 8
            echo "            ";
        ...
        ";
            ...
            // line 12
            echo "                <code>";
            echo twig_escape_filter($this->env, (isset($context["partition_method"]) ? $context["partition_method"] : null), "html", null, true);
            echo "(";
            echo twig_escape_filter($this->env, (isset($context["partition_expression"]) ? $context["partition_expression"] : null), "html", null, true);
            echo ")</code>
            </p>
            ";
            // line 14
            if ((isset($context["has_sub_partitions"]) ? $context["has_sub_partitions"] : null)) {
                ...
                // line 17
                echo "                    <code>";
                echo twig_escape_filter($this->env, (isset($context["sub_partition_method"]) ? $context["sub_partition_method"] : null), "html", null, true);
                echo "(";
                echo twig_escape_filter($this->env, (isset($context["sub_partition_expression"]) ? $context["sub_partition_expression"] : null), "html", null, true);
                echo ")</code>
                <p>
            ";
            }
            ...
            echo "</th>
                        ";
            // line 25
            if ((isset($context["has_description"]) ? $context["has_description"] : null)) {
                // line 26
                echo "                            <th>";
            ...
            echo "</th>
                        <th colspan=\"";
            // line 32
            echo (((isset($context["range_or_list"]) ? $context["range_or_list"] : null)) ? ("7") : ("6"));
            echo "\">
                            ";
            // line 33
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["partitions"]) ? $context["partitions"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["partition"]) {
                // line 39
                echo "                    <tr class=\"noclick";
                echo (((isset($context["has_sub_partitions"]) ? $context["has_sub_partitions"] : null)) ? (" marked") : (""));
                echo "\">
                        ";
                // line 40
                if ((isset($context["has_sub_partitions"]) ? $context["has_sub_partitions"] : null)) {
...
$context["partition"], "getDataLength", array(), "method"), 3, 1);
                // line 64
                echo "                            <span>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["data_length"]) ? $context["data_length"] : null), 0, array(), "array"), "html", null, true);
                echo "</span>
                            <span class=\"unit\">";
                // line 65
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["data_length"]) ? $context["data_length"] : null), 1, array(), "array"), "html", null, true);
                echo "</span>
                        </td>
                        <td class=\"value\">
                            ";
...
$context["partition"], "getIndexLength", array(), "method"), 3, 1);
                // line 73
                echo "                            <span>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index_length"]) ? $context["index_length"] : null), 0, array(), "array"), "html", null, true);
                echo "</span>
                            <span class=\"unit\">";
                // line 74
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index_length"]) ? $context["index_length"] : null), 1, array(), "array"), "html", null, true);
                echo "</span>
                        </td>
                        <td>";
                // line 76
                ...
                // line 77
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable((isset($context["action_icons"]) ? $context["action_icons"] : null));
                foreach ($context['_seq'] as $context["action"] => $context["icon"]) {
                    ...
                    // line 81
                    echo twig_escape_filter($this->env, twig_urlencode_filter(((((("ALTER TABLE " . PhpMyAdmin\Util::backquote((isset($context["table"]) ? $context["table"] : null))) . " ") . $context["action"]) . " PARTITION ") . $this->getAttribute(                    // line 82
...
$context["sub_partition"], "getIndexLength", array(), "method"), 3, 1);
    ...
    <fieldset class=\"tblFooters print_ignore\">
        ...
        if (twig_test_empty((isset($context["partitions"]) ? $context["partitions"] : null))) {
            ...
            // line 137
            echo "                ";
            echo PhpMyAdmin\Util::linkOrButton((isset($context["remove_url"]) ? $context["remove_url"] : null), _gettext("Remove partitioning"), array("class" => "button ajax", "id" => "remove_partitioning"));
            // line 140
            echo "
...
";
    ...
    {
        return new Twig_Source("", "table/structure/display_partitions.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/table/structure/display_partitions.twig");
    }
}
