...
class __TwigTemplate_36f26ce959badba65c5386a12e9b086096578dda81945356e635973e344fd719 extends Twig_Template
{
        ...
        if (PhpMyAdmin\Util::isForeignKeySupported((isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null))) {
            ...
            if ( !twig_test_empty((isset($context["existrel_foreign"]) ? $context["existrel_foreign"] : null))) {
                ...
                foreach ($context['_seq'] as $context["key"] => $context["one_key"]) {
                    ...
                    // line 40
                    echo "                        ";
                    $context["foreign_db"] = ((($this->getAttribute($context["one_key"], "ref_db_name", array(), "array", true, true) &&  !(null === $this->getAttribute(                    // line 41
$context["one_key"], "ref_db_name", array(), "array")))) ? ($this->getAttribute(                    // line 42
$context["one_key"], "ref_db_name", array(), "array")) : ((isset($context["db"]) ? $context["db"] : null)));
                    // line 43
                    echo "                        ";
                    ...
                    if ((isset($context["foreign_db"]) ? $context["foreign_db"] : null)) {
                        // line 45
                        echo "                            ";
                        $context["foreign_table"] = ((($this->getAttribute($context["one_key"], "ref_table_name", array(), "array", true, true) &&  !(null === $this->getAttribute(                        // line 46
$context["one_key"], "ref_table_name", array(), "array")))) ? ($this->getAttribute(                        // line 47
$context["one_key"], "ref_table_name", array(), "array")) : (false));
                        // line 48
                        echo "                        ";
                    }
                    // line 49
                    echo "                        ";
                    $context["unique_columns"] = array();
                    // line 50
                    echo "                        ";
                    if (((isset($context["foreign_db"]) ? $context["foreign_db"] : null) && (isset($context["foreign_table"]) ? $context["foreign_table"] : null))) {
                        ...
                        // line 52
                        echo "                            ";
                        $context["unique_columns"] = $this->getAttribute((isset($context["table_obj"]) ? $context["table_obj"] : null), "getUniqueColumns", array(0 => false, 1 => false), "method");
                        // line 53
                        echo "                        ";
                    }
                    // line 54
                    echo "                        ";
                    $this->loadTemplate("table/relation/foreign_key_row.twig", "table/relation/common_form.twig", 54)->display(array("i" =>                     // line 55
...
(isset($context["unique_columns"]) ? $context["unique_columns"] : null)));
            ...
            // line 71
            echo "                ";
            $this->loadTemplate("table/relation/foreign_key_row.twig", "table/relation/common_form.twig", 71)->display(array("i" =>             // line 72
(isset($context["i"]) ? $context["i"] : null), "one_key" => array(), "column_array" =>             // line 74
...
(isset($context["unique_columns"]) ? $context["unique_columns"] : null)));
    ...
    ";
        // line 97
        if ($this->getAttribute((isset($context["cfg_relation"]) ? $context["cfg_relation"] : null), "relwork", array(), "array")) {
            // line 98
            echo "        ";
            if (PhpMyAdmin\Util::isForeignKeySupported((isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null))) {
                // line 99
        ...
        <fieldset>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 117
                echo "                        ";
                $context["myfield"] = $this->getAttribute($this->getAttribute((isset($context["save_row"]) ? $context["save_row"] : null), $context["i"], array(), "array"), "Field", array(), "array");
                // line 118
                echo "                        ";
                // line 120
                echo "                        ";
                ...
                // line 126
                echo "                        ";
                if ($this->getAttribute((isset($context["existrel"]) ? $context["existrel"] : null), (isset($context["myfield"]) ? $context["myfield"] : null), array(), "array", true, true)) {
                    // line 127
                    echo "                            ";
                    $context["foreign_db"] = $this->getAttribute($this->getAttribute((isset($context["existrel"]) ? $context["existrel"] : null), (isset($context["myfield"]) ? $context["myfield"] : null), array(), "array"), "foreign_db", array(), "array");
                    // line 128
                    echo "                        ";
                } else {
                    // line 129
                ...
                if ((isset($context["foreign_db"]) ? $context["foreign_db"] : null)) {
                    ...
                    if ($this->getAttribute((isset($context["existrel"]) ? $context["existrel"] : null), (isset($context["myfield"]) ? $context["myfield"] : null), array(), "array", true, true)) {
                        // line 136
                        echo "                                ";
                        $context["foreign_table"] = $this->getAttribute($this->getAttribute((isset($context["existrel"]) ? $context["existrel"] : null), (isset($context["myfield"]) ? $context["myfield"] : null), array(), "array"), "foreign_table", array(), "array");
                        // line 137
                        echo "                            ";
                    }
                    // line 138
                    echo "                            ";
                    $context["tables"] = $this->getAttribute((isset($context["dbi"]) ? $context["dbi"] : null), "getTables", array(0 => (isset($context["foreign_db"]) ? $context["foreign_db"] : null)), "method");
                    // line 139
                    echo "                        ";
                }
                // line 140
                ...
                if (((isset($context["foreign_db"]) ? $context["foreign_db"] : null) && (isset($context["foreign_table"]) ? $context["foreign_table"] : null))) {
                    ...
                    if ($this->getAttribute((isset($context["existrel"]) ? $context["existrel"] : null), (isset($context["myfield"]) ? $context["myfield"] : null), array(), "array", true, true)) {
                        // line 145
                        echo "                                ";
                        $context["foreign_column"] = $this->getAttribute($this->getAttribute((isset($context["existrel"]) ? $context["existrel"] : null), (isset($context["myfield"]) ? $context["myfield"] : null), array(), "array"), "foreign_field", array(), "array");
                        // line 146
                        echo "                            ";
                    }
                    // line 147
                ...
                echo "
                        ";
                // line 151
                $this->loadTemplate("table/relation/internal_relational_row.twig", "table/relation/common_form.twig", 151)->display(array("myfield" =>                 // line 152
...
(isset($context["foreign_column"]) ? $context["foreign_column"] : null)));
    ...
    ";
        // line 169
        if ($this->getAttribute((isset($context["cfg_relation"]) ? $context["cfg_relation"] : null), "displaywork", array(), "array")) {
            // line 170
            echo "        ";
            $context["disp"] = call_user_func_array($this->env->getFunction('Relation_getDisplayField')->getCallable(), array((isset($context["db"]) ? $context["db"] : null), (isset($context["table"]) ? $context["table"] : null)));
            // line 171
            echo "        <fieldset>
            <label>";
            // line 172
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                // line 176
                echo "                    <option value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($context["row"], "Field", array(), "array"), "html", null, true);
                echo "\"";
                // line 177
                if ((array_key_exists("disp", $context) && ($this->getAttribute($context["row"], "Field", array(), "array") == (isset($context["disp"]) ? $context["disp"] : null)))) {
                    // line 178
...
";
    ...
    {
        return new Twig_Source("", "table/relation/common_form.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/table/relation/common_form.twig");
    }
}
