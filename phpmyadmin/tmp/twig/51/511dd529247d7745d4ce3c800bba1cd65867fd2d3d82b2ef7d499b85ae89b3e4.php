...
class __TwigTemplate_924b5cb9d4beb159b80bc64cf72776471197afe3c3e408087860dec6b6301424 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["mi"]) {
            // line 10
            echo "        <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["move_columns"]) ? $context["move_columns"] : null), $context["mi"], array(), "array"), "name", array()), "html", null, true);
            echo "\"";
            // line 11
            ...
            ";
            // line 12
            echo twig_escape_filter($this->env, sprintf(_gettext("after %s"), PhpMyAdmin\Util::backquote(twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["move_columns"]) ? $context["move_columns"] : null), $context["mi"], array(), "array"), "name", array())))), "html", null, true);
            echo "
        </option>
    ";
        }
...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/move_column.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/columns_definitions/move_column.twig");
    }
}
