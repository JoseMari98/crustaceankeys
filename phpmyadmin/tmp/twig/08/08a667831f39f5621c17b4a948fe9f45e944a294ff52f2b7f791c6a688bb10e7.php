...
class __TwigTemplate_b9edd262284f76787fe798ef4e387ff9543fac665c5c57c4ff811bf9ace84879 extends Twig_Template
{
...
(isset($context["pma_theme_image"]) ? $context["pma_theme_image"] : null), "text_dir" =>         // line 4
(isset($context["text_dir"]) ? $context["text_dir"] : null), "form_name" => "fieldsForm"));
        // line 7
        echo "
    ";
        // line 8
    ...
    ";
        ...
        ";
            // line 32
            if (((isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null) != "ARCHIVE")) {
                // line 33
                echo "            ";
            ...
            ";
                // line 62
                if (( !twig_test_empty((isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null)) && (((                // line 63
(isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null) == "MYISAM") || (                // line 64
(isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null) == "ARIA")) || (                // line 65
(isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null) == "MARIA")))) {
                    // line 66
                    echo "                ";
                    echo PhpMyAdmin\Util::getButtonOrImage("submit_mult", "mult_submit", _gettext("Fulltext"), "b_ftext", "ftext");
                    // line 72
...
";
    ...
    {
        return new Twig_Source("", "table/structure/check_all_table_column.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/table/structure/check_all_table_column.twig");
    }
}
