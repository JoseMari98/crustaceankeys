...
class __TwigTemplate_0b1e72668796e78b62f0e00114ccb3990bf9dd2175ceaf91269bbcc87841b4b1 extends Twig_Template
{
    ...
    ";
        // line 5
        if (((isset($context["overhead_check"]) ? $context["overhead_check"] : null) != "")) {
            // line 6
    ...
    ";
        ...
        ";
        // line 13
        if (( !(isset($context["db_is_system_schema"]) ? $context["db_is_system_schema"] : null) &&  !(isset($context["disable_multi_table"]) ? $context["disable_multi_table"] : null))) {
            // line 14
            echo "            <optgroup label=\"";
        ...
        // line 31
        echo "        ";
        if ((array_key_exists("central_columns_work", $context) && (isset($context["central_columns_work"]) ? $context["central_columns_work"] : null))) {
            // line 32
            echo "            <optgroup label=\"";
    ...
    ";
        // line 39
        echo twig_join_filter((isset($context["hidden_fields"]) ? $context["hidden_fields"] : null), "
");
        echo "
</div>
";
    ...
    {
        return new Twig_Source("", "database/structure/check_all_tables.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/database/structure/check_all_tables.twig");
    }
}
