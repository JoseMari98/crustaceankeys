...
class __TwigTemplate_a45c29115386c3377f13cdc57d238ebbff06b2a1e7f74a43ce12a38946213e72 extends Twig_Template
{
...
(isset($context["content"]) ? $context["content"] : null), "class" => "li_switch_dbstats", "url" => array("href" => ("server_databases.php" . PhpMyAdmin\Url::getCommon(array("dbstats" => "1"))), "title" => _gettext("Enable statistics"))));
            // line 78
            echo "    ";
            $this->loadTemplate("list/unordered.twig", "server/databases/databases_footer.twig", 78)->display(array("items" => (isset($context["items"]) ? $context["items"] : null)));
        }
        // line 80
        echo "</form>
</div>
";
    ...
    {
        return new Twig_Source("", "server/databases/databases_footer.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/server/databases/databases_footer.twig");
    }
}
