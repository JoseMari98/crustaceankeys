...
class __TwigTemplate_f7e685e23ce1a2b9196c12ed158f83c546ca0e4145f67656fc2b4593eea1bf8c extends Twig_Template
{
    ...
    <fieldset>
        ...
        ";
        // line 4
        if ($this->getAttribute((isset($context["showtable"]) ? $context["showtable"] : null), "TABLE_COMMENT", array(), "array")) {
            // line 5
            echo "            <p>
                <strong>";
            // line 6
            ...
            echo "</strong>
                ";
            // line 7
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["showtable"]) ? $context["showtable"] : null), "TABLE_COMMENT", array(), "array"), "html", null, true);
            echo "
            </p>
        ";
        }
        ...
        if (( !(isset($context["tbl_is_view"]) ? $context["tbl_is_view"] : null) &&  !(isset($context["db_is_system_schema"]) ? $context["db_is_system_schema"] : null))) {
            ...
            echo "
                ";
            // line 43
            if ((array_key_exists("tot_size", $context) && ((isset($context["mergetable"]) ? $context["mergetable"] : null) == false))) {
                // line 44
                echo "                    <tr>
                        <th class=\"name\">";
                // line 45
...
array_key_exists("avg_size", $context)) ? ((isset($context["avg_size"]) ? $context["avg_size"] : null)) : (null)), "avg_unit" => ((        // line 76
array_key_exists("avg_unit", $context)) ? ((isset($context["avg_unit"]) ? $context["avg_unit"] : null)) : (null))));
        // line 78
        echo "    </fieldset>
</div>
";
    ...
    {
        return new Twig_Source("", "table/structure/display_table_stats.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/table/structure/display_table_stats.twig");
    }
}
