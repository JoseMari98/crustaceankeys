...
class __TwigTemplate_ce5c77db387de0951ea16ccf935746ed079de9e4dd68f00eb17474bb19e1a3ca extends Twig_Template
{
    ...
    <input type=\"hidden\" name=\"err_url\" value=\"";
        // line 4
        echo twig_escape_filter($this->env, (isset($context["err_url"]) ? $context["err_url"] : null), "html", null, true);
        echo "\">
    ...
    ";
        // line 7
        if ((isset($context["has_where_clause"]) ? $context["has_where_clause"] : null)) {
            // line 8
            echo "        ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["where_clause_array"]) ? $context["where_clause_array"] : null));
    ...
    ";
        ...
        // line 16
        echo twig_escape_filter($this->env, (isset($context["insert_rows_default"]) ? $context["insert_rows_default"] : null), "html", null, true);
        echo "\" min=\"1\">
    ";
        $context["insert_rows"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 18
        echo "    ";
        echo sprintf(_gettext("Continue insertion with %s rows"), (isset($context["insert_rows"]) ? $context["insert_rows"] : null));
        echo "
</form>
";
    }
    ...
    {
        return new Twig_Source("", "table/insert/continue_insertion_form.twig", "/home/crustaceankeys/public_html/phpmyadmin/templates/table/insert/continue_insertion_form.twig");
    }
}
